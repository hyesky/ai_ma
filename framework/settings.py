...
PROJECT_UA = "ai_ma"
PROJECT_BUILT = "ai_ma built on 2026/08/06"
PROJECT_VERSION = "1.003"
PROJECT_FLAG = "ai_ma" # ai_ma
...
SECRET_KEY = 'ai_ma-insecure-oam*2x=@ynuv5w*&$*yc-1cjsku-b2@$x*t9!swd+n0glv76'
...
SESSION_COOKIE_NAME = 'Ai_maSessionID'
